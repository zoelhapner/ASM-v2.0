            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('employee_workers.update', $workers->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="last_position" class="form-control" value="{{ old('last_position', $workers->last_position) }}">
                                </div>
                                ...
                                <div class="mb-3">
                                            ...
                                            <input type="number" name="last_salary" class="form-control" value="{{ old('last_salary', $workers->last_salary) }}">
                                </div>

                                <div class="mb-3">
                                            <label class="form-label">Alasan Keluar</label>
                                            <input type="text" name="reason_for_leaving" class="form-control" value="{{ old('reason_for_leaving', $workers->reason_for_leaving) }}">
                                </div>
